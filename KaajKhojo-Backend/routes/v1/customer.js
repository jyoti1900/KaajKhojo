...
const homepageCompanyDetails = require("../../controller/customer/homepage_company details");
router.get("/Companydetails", homepageCompanyDetails.getAllCompanyDetails);
